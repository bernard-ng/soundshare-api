...
class Hasher {
    ...
    browse(stats: Stats | Dirent, dirname: string): Promise<any> {
...
class HashedFolder {
    private name: string
    private children: Array<HashedFile | HashedFolder>
    private stats: string

    constructor(stats: Stats | Dirent, children: Array<HashedFile | HashedFolder>) {
...
class HashedFile {
    ...
    constructor(stats: Stats | Dirent) {
